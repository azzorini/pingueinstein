#!/home/docchigo/.local/bin/python3
# -*- coding: utf-8 -*-
...
# len("insulta a ") == 10
@bot.message_handler(func=lambda message: message.content_type == "text" and (message.text.lower()[:10] == "insulta a " or message.text.lower()[:10] == "Insulta a " ))
def insulto(m):
    cid = m.chat.id
    name = m.text[10:]
...
@bot.message_handler(func=lambda message: message.content_type == "text" and "ignacio" in message.text.lower())
def Ignacio(m):
