...
Config.instname = "University of Granada"
Config.profilename = "eduroam"
Config.url = "http://csirc.ugr.es"
Config.email = "cvi@ugr.es"
Config.title = "eduroam CAT"
Config.servers = ['DNS:radius.ugr.es']
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.server_match = 'radius.ugr.es'
...
"""
Config.anonymous_identity = 'anonymous@ugr.es'
Config.init_info = """This installer has been prepared for {0}\n\nMore information and comments:\n\nEMAIL: {1}\nWWW: {2}\n\nInstaller created with software from the GEANT project."
"""
Config.init_confirmation = "This installer will only work properly if you are a member of {0}."
Config.sb_user_file = """"""
Config.user_realm = "ugr.es"
run_installer()
